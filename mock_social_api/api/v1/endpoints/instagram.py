...
import httpx
from mock_social_api.schemas.response_schema import IResponseActivity, IResponseBolean, IResponseCounter, IResponseLatestPost
...
@router.get("/daily-activity", response_model=IResponseActivity)

...
class IResponseLatestPost(BaseModel):
    link: HttpUrl  | None = None

class IResponseBolean(BaseModel):
    result: bool = False
...
class IResponseCounter(BaseModel):
    result: int
    username: str | None = None  

class IResponseActivity(BaseModel):
    followers: int
    stories_with_hashtag: int
